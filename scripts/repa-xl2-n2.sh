...
mpirun -np 2 \
    ...
    ./train_feat_repa.py --model DiT-XL/2 --global-batch-size 512 --features-path /work/c30636/dataset/dit_feat_repa/train --dino-path /work/c30636/dataset/dit_feat_repa_dino/train --repa-lambda 0.5 --align-depth 8
