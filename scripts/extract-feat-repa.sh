...
mpirun -np 1 \
    ...
    ./extract_features_repa.py --data-path /work/c30778/dataset/imagenet \
    --features-path /work/c30636/dataset/dit_feat_repa \
    --dino-path /work/c30636/dataset/dit_feat_repa_dino \
    --batch-size 64
