#!/bin/bash
CKDIR=/work/c30636/DiT/results/012-DiT-XL-2-rae-flow/checkpoints
SUB=/work/c30636/DiT/.ddt012_submitted
OUT=/work/c30636/DiT/outputs/fid_rae_ddt.txt
JOB=553955
touch "$SUB"
while true; do
