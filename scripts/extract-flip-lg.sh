...
cd /work/c30636/DiT
OUT=/work/c30636/dataset/rae_dinov3l_k7_latents_flip/train
...
mpirun -np 2 --map-by ppr:1:node --bind-to none \
  ...
  ./extract_rae_latents.py --flip --data-path /work/c30778/dataset/imagenet/train --out "$OUT" --batch-size 64 --max-classes 0
