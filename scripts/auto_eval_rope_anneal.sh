#!/bin/bash
CKDIR=/work/c30636/DiT/results/017-DiT-XL-2-rae-flow/checkpoints
SUB=/work/c30636/DiT/.rope017_submitted
OUT=/work/c30636/DiT/outputs/fid_rae_rope_anneal.txt
JOB=555614
touch "$SUB"
while true; do
...
echo "RoPE-anneal(017) AUTO-EVAL DONE"
