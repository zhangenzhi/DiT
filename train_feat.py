...
# 运行示例:
# torchrun --nnodes=1 --nproc_per_node=4 train_feat.py --model DiT-B/2 --features-path /work/c30778/dataset/dit_feat --bf16 --resume results/002-DiT-B-2/checkpoints/0460000.pt